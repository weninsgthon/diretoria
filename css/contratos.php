            ...
            <div class="col-md-4">
             <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-line-chart" aria-hidden="true"></i>
          ...
          <table class="table table-hover table-striped">
                     <thead>
                      <tr>
                        ...
                        <th class="success text-center">Moeda</th>
                        <th class="success text-center">Quantidade <br></th>
                     ...
                     <table class="table table-hover table table-striped">
                      ...
                      <tbody class="text-center">
                        <tr>
                          <td>CM17/01-SJ</td>
                          <td>02/01/2017</td>
                          <td>AMAGGI EXPORTÇÃO E IMPORTAÇÃO LTDA</td>
                          <td>SOJA CONVENCIONAL</td>
